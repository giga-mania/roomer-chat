...
const ToggleThemeContainer = styled.button`
  ...
  outline: none;
  background: none;
  box-shadow: -2px -2px 3px ${({ theme }) => theme.light},
    3px 4px 4px ${({ theme }) => theme.shadow},
  ...
  .switch {
    ...
    lightTheme ? "translateX(0)" : "translateX(1.8rem)"};
...
const ToggleTheme = ({ theme, toggleTheme }) => {
    ...
    return (
        <ToggleThemeContainer lightTheme={isLight} onClick={toggleTheme}>
